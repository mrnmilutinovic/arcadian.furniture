      ...
      <main className="pt-32 pb-20 px-6 md:px-12 max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg font-sans text-ink/70 space-y-8">
          ...
          <section>
            ...
            <p>
              By accessing or using the Arcadian website and services, you agree to be bound by these
              Terms and Conditions. If you do not agree to these terms, please do not use our services.
            </p>
          </section>

          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">2. Pre-Order & Kickstarter</h2>
            <p>
              Arcadian products will be available through our Kickstarter campaign launching in March 2026.
              By joining our mailing list, you are expressing interest and will receive updates about
              the campaign. No payment is required until the Kickstarter campaign is live.
            </p>
          </section>

          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">3. Product Information</h2>
            <p>
              We strive to provide accurate product descriptions, images, and specifications. However,
              as our products are in development, final specifications may vary. We will communicate
              any significant changes to backers before fulfillment.
            </p>
          </section>

          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">4. Intellectual Property</h2>
            <p>
              All content on this website, including text, images, logos, and designs, is the property
              of Arcadian and is protected by intellectual property laws. You may not reproduce,
              distribute, or create derivative works without our express permission.
            </p>
          </section>

          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">5. Limitation of Liability</h2>
            <p>
              Arcadian shall not be liable for any indirect, incidental, special, or consequential
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">6. Governing Law</h2>
            <p>
          ...
          <section>
            ...
            <p>
              For questions about these Terms & Conditions, please contact us at hello@arcadian.furniture
            </p>
          </section>
        </div>
      </main>
