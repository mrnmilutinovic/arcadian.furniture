        ...
        <div className="prose prose-lg font-sans text-ink/70 space-y-8">
          ...
          <section>
            ...
            <p>
              ...
              you sign up for our mailing list. We may also collect usage data about how you
              interact with our website.
            </p>
          </section>

          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">2. How We Use Your Information</h2>
            <p>We use the information we collect to:</p>
            <ul className="list-disc pl-6 space-y-2 mt-4">
              <li>Send you updates about our Kickstarter campaign and product launches</li>
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">3. Information Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">4. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">5. Your Rights</h2>
          ...
          <section>
            ...
            <p>
              ...
              your browser to refuse cookies, though this may affect some website functionality.
            </p>
          </section>

          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">7. Changes to This Policy</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              please contact us at hello@arcadian.furniture
            </p>
          </section>
        </div>
      </main>
